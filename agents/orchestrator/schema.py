...
class ArchiveCreate(BaseModel):
    ...
    archive_type: str = Field(description="Must accurately reflect the media (e.g., 'image', 'audio', 'document').")
    ...
    caption: Optional[str] = Field(description="Concise caption for the media.")
    alt_text: Optional[str] = Field(description="Accessibility text (e.g., 'Young Igbo Woman Painted with Uli', or 'Audio recording of traditional flutes').")
